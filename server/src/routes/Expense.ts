...
import { getAllExpenses, createExpense, deleteExpenseById, updateExpenseById, getExpenseById, getExpensesByCategories, getExpensesByexpenseType } from "../controllers/Expense";
...
router.get("/expenseType",requireAuth, getExpensesByexpenseType);
